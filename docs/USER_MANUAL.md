...
- **Extensions**: You can manually install extensions in the launched browser, and they *should* persist if they store data in the user directory (though Playwright has some limitations with extensions in automation mode).
